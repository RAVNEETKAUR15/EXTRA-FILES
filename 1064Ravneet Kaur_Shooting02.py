...
def func(x,E,l0,m,N):
    ...
    #IC1=[np.exp(0),k1[0]*np.exp(2**2)]
    #IC2=[np.exp(1*2**2),-k2[0]*np.exp((2)*(2))]
    IC1=np.real(np.array([np.exp(1j*k1[0]*f),1j*k1[0]*np.exp(1j*k1[0]*f)]))
    IC2=-np.real(np.array([np.exp(1j*k2[0]*(-f)),-1j*k2[0]*np.exp(1j*k2[0]*(-f))]))

    res1=RK4(Sol1, IC2,-f,0,N,k1)
    res2=RK4(Sol1, IC1,f,0,N,k2)
